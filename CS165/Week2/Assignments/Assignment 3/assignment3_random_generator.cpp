/**********
** Program: assignment3_random_generator.cpp
** Author: Aryan Aziz
...
int main(){
	...
	randomNum = rand() % (maxRange - minRange) + minRange; //Generate a random number between the minimum range and the (maximum range - minimum range)
