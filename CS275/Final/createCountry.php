...
<html>
	<head>
		<meta charset="UTF-8">
		<title>CS275 - Final - Country Creation</title>
	...
	<body>
		...
		<script>
			window.onload = function() {
				var error = gup('error');
				if(error == 1) {
					document.getElementById('error').innerHTML += '<div class="alert alert-danger">Country name must be unique. Please try again.</div>';
				}
			}
		</script>
	</body>
