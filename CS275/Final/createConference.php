...
<html>
	<head>
		<meta charset="UTF-8">
		<title>CS275 - Final - Conference Creation</title>
	...
	<body>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<form method="get" action="create.php">
						...
						<input type="text" name="name" required="" class="form-control" placeholder="Conference Name (Don't include Conference)">
						<br>
		...
		<script>
			window.onload = function() {
				var error = gup('error');
				if(error == 1) {
					document.getElementById('error').innerHTML += '<div class="alert alert-danger">Conference name must be unique. Please try again.</div>';
				}
			}
		</script>
	</body>
